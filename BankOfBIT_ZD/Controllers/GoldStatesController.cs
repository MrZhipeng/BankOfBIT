...
namespace BankOfBIT_ZD.Controllers
{
    public class GoldStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] GoldState goldState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] GoldState goldState)
        {
            if (ModelState.IsValid)
            {
