...
namespace BankOfBIT_ZD.Controllers
{
    public class PlatinumStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] PlatinumState platinumState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] PlatinumState platinumState)
        {
            if (ModelState.IsValid)
            {
