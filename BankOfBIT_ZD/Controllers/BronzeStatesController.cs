...
namespace BankOfBIT_ZD.Controllers
{
    public class BronzeStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] BronzeState bronzeState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] BronzeState bronzeState)
        {
            if (ModelState.IsValid)
            {
