...
namespace BankOfBIT_ZD.Controllers
{
    public class SilverStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] SilverState silverState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] SilverState silverState)
        {
            if (ModelState.IsValid)
            {
