...
namespace BankOfBIT_ZD.Controllers
{
    public class AccountStatesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] AccountState accountState)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AcountStateId,LowerLimit,UpperLimit,Rate")] AccountState accountState)
        {
            if (ModelState.IsValid)
            {
