...
namespace BankOfBIT_ZD.Controllers
{
    public class BankAccountsController : Controller
    {
        ...
        {
            ViewBag.AccountStateId = new SelectList(db.AccountStates, "AcountStateId", "AcountStateId");
        ...
        public ActionResult Create([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes")] BankAccount bankAccount)
        {
            ...
            ViewBag.AccountStateId = new SelectList(db.AccountStates, "AcountStateId", "AcountStateId", bankAccount.AccountStateId);
